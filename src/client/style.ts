...
.dshcm-track.dshcm-collapsed{border-radius:2px;cursor:pointer;border-color:transparent;background:color-mix(in srgb,var(--dsw-alias-bg-layer-2,#7f8896) 14%,transparent);}
